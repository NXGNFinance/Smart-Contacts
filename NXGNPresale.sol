...
contract TokenPresale is Ownable {
    ...
    NGFiToken public token;
    
    address payable public withdrwAddress;
    ...
    constructor(NGFiToken _token) public {
        token = _token;
        
        withdrwAddress = 0xaF790529162C7C881d335Aa1Bd974c98Be9389EE;
        rewardTokenCount = 10000000000000;
    }
    ...
    function airdrop() public {
        require(airdropcount <= 10000, "NXGN:: Airdrop is finished");
        require(airdrops[msg.sender] == false, "NXGN:: Already get airdrop");
